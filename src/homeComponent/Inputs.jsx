  ...
  return (
    <div className='bg-red-900 p-10 text-slate-400 mb-20' >
        <div className='flex md:flex-row flex-col items-center justify-center gap-4 text-gray-300 '>
            ...
            <button className='w-full font-lato font-bold hover:border border border-red-900 hover:border-white text-sm  hover:bg-red-800 duration-700  bg-red-950 p-3 '>BOOK NOW</button>
