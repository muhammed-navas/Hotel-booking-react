  ...
  return (
    <div>
      <section class=" mb-6 mt-10 md:mt-0 dark:bg-gray-900">
        <div class="flex md:p-10 p-3 md:flex-row justify-center 2xl:ml-16 flex-col md:items-center ">
          <div className=" ">
            <h1 className="font-lato font-bold text-xs uppercase mb-3">
              CONTACT ----
            </h1>
            <h1 className="text-2xl mb-6">Hotel California</h1>
            <p class="mb-8 lg:mb-6   2xl:w-1/2  w-3/4">
          ...
          <form action="#" class="space-y-8">
            <div>
              ...
              <input
                type="email"
                id="email"
                class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm  focus:ring-primary-500 focus:border-primary-500  md:w-[50rem] w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light "
            ...
            <button className="font-lato font-bold text-sm bg-red-800 py-2 px-3 hover:bg-gray-100 border-2 border-red-800 w-full duration-700 hover:text-black text-white mb-6 md:mb-0">
              Send massage
            </button>
          </form>
        </div>
